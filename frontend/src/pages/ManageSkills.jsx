...
function ManageSkills() {
  ...
  const loadSkills = async () => {
    try {
      const res = await axios.get("https://devfolio-backend-production-6da2.up.railway.app/api/skills");
      setSkills(res.data);
    } catch (err) {
      console.log(err);
    }
  ...
  const addSkill = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        await axios.put(
          `https://devfolio-backend-production-6da2.up.railway.app/api/skills/${editingId}`,
          {
            name: skill,
          }
        );
        ...
        await axios.post(
          "https://devfolio-backend-production-6da2.up.railway.app/api/skills",
          {
            name: skill,
          }
        );
  ...
  const deleteSkill = async (id) => {
    ...
    try {
      ...
      await axios.delete(
        `https://devfolio-backend-production-6da2.up.railway.app/api/skills/${id}`
      );
